...
describe("input correct city name then click button", () => {
    ...
    it ("should display weather information within 2.5 seconds", function(done) {
        const button = container.querySelector('button');
        ReactTestUtils.Simulate.click(button);
        setTimeout(function() {
    ...
    it("should display weather forecast of next 24 hours within 1 second", function(done) {
        const button = container.querySelector('button');
        ReactTestUtils.Simulate.click(button);
        setTimeout(function() {
